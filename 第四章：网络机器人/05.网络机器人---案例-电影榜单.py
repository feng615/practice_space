...
def get_movie_detail(movie_detail_url):
    ...
    all_movie_datetime = movie_doc.xpath("//*[@id='original_header']/div[2]/section/div[1]/div/span[2]/text()")
    all_movie_type = movie_doc.xpath("//*[@id='original_header']/div[2]/section/div[1]/div/span[3]/a/text()")
    all_movie_time = movie_doc.xpath("//*[@id='original_header']/div[2]/section/div[1]/div/span[4]/text()")
...
def main():
   for page_num in range(1, 6):
       ...
       div_list = doc.xpath(
           "/html/body/div[1]/main/section/div/div/div/div[2]/div[2]/div/section/div/div/div[1]/div/div")
       # 遍历电影榜单数据，获取电影详情
